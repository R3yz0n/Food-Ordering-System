...
const Header = () => {
    ...
    return (
        ...
        <header className='fixed backdrop-blur-sm bg-gray-100 bg-opacity-80 z-50 inset-x-0 top-0 flex items-center justify-between px-12 md:px-20  pt-2 w-full border-[1px] border-b-gray-400'>
