...
const Banner = () => {
    ...
    return (
        ...
        <section className="relative w-full bg-black h-[450px] md:h-[70vh] text-white flex overflow-hidden " id='banner' >
            ...
            <aside className='flex mx-auto  w-[90%] xl:w-[80%]  z-30 h-full '>
                ...
                <h3 className='text-[36px] sm:text-[44px] font-bold'>Enjoy Our Delicious Meal</h3>
                    <h5 className='font-semibold opacity-90  sm:text-lg lg:pr-8'>A restaurant is a place where people go to enjoy a meal, typically with friends, family, or colleagues.</h5>

                    <motion.button {...btnClick} className='bg-orange-600 shadow-sm  hover:bg-orange-500 shadow-orange-500 font-sans px-3 py-[6px] sm:px-4 sm:py-2 w-44 mt-5 sm:mt-0 sm:w-52 rounded-md tracking-wider text-white text-lg sm:text-xl font-extrabold'>
