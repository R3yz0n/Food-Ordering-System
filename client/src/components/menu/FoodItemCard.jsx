...
const FoodItemCard = ({ item }) => {
    return (
        <motion.div className=' duration-200 bg-card drop-shadow-md hover:shadow-lg hover:shadow-gray-400  flex items-center w-[350px] xs:w-225  sm:w-300 md:w-[230px] lg:w-[290px] py-4 p-2 gap-1 rounded-lg mx-auto relative h-[10rem] '>
            ...
            <motion.div className='w-7 h-7 p-1 rounded-full bg-red-500 flex items-center justify-center absolute top-2 right-2 cursor-pointer' {...btnClick}>
                <RiShoppingBasketFill className='text-2xl text-primary' />
