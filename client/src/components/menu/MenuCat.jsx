...
const MenuCat = ({ handleFilter, category, handleSearch, searchKeyword }) => {
                ...
                <div className='w-4/5 sm:w-[70%] lg:w-1/3 mx-auto flex gap-3  flex-col  lg:pl-8 pt-2 lg:pt-5 '>
                    ...
                    <div className="mb-3">
                        ...
                        <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                            <input type="search" className="relative focus:shadow-md shadow-black m-0 -mr-0.5 block w-[1px]  min-w-0 flex-auto rounded-l border-2 border-solid border-gray-600 bg-transparent bg-clip-padding px-3 py-[0.25rem] text-lg text-black font-normal leading-[1.6] outline-none transition duration-200 ease-in-out focus:border-red-600  focus:text-neutral-700  focus:outline-none" placeholder="Search food here" onChange={(e) => handleSearch(e.target.value)} value={searchKeyword} />
