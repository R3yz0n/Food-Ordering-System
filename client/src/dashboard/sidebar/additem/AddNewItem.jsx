...
const AddNewItem = () => {
  ...
  return (
    <form
      className="flex items-center justify-center flex-col  max-w-screen-md mx-auto w-full px-4 h-[85vh] pt-6"
      onSubmit={handleSubmit}
    >
      <aside className="border border-purple-200 shadow-xl rounded-md p-4 w-full flex flex-col items-center  justify-center gap-4 py-6 pb-10 my-auto">
        ...
        <section className="flex gap-10 w-full mt-4 px-3">
          ...
          <motion.section {...fadeInOut} className="w-2/3 overflow-hidden">
            ...
            {product.error?.length > 1 && (
              <motion.div
                className=" text-red-600 px-2 mt-2"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
