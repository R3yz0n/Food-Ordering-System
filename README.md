...
This application uses native ETH as a payment method on the Ethereum Sepolia testnet network. Follow these steps to set up your wallet and make payments:
...
3. **Get Test ETH**
    - Visit the [Google Cloud Ethereum Sepolia Faucet](https://cloud.google.com/application/web3/faucet/ethereum/sepolia)
    - Request test ETH for your Sepolia wallet address
    - Wait for the transaction to complete

### Making Payments

1. Ensure you have sufficient Sepolia test ETH balance
...
- This is a testnet implementation using test ETH
- Never send real/mainnet cryptocurrency to testnet addresses
